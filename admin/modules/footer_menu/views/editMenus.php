                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-6">
                        <div class="card p-3">
                            ...
                            <form id="addMenuForm" action="<?php echo SITEURL;?>footer_menu/updateMenuDetails" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <span id="conid">
                                            <select class="form-select" name="menu_content">
                                                <option value="" selected>--Please Select Content--</option>
...
$.ajax({
    type: 'post',
    url: "<?php echo SITEURL;?>footer_menu/ajaxDisplayMenu",
    data: 'getmenus=1',
    cache: false,
...
$('#serialize').click(function () {
    ...
    $.ajax({
        method: 'post',
        url: "<?php echo SITEURL;?>footer_menu/ajaxSaveMenu",
...
if(option == 'page') {
    ...
    $.ajax({
        url:'<?php echo SITEURL; ?>footer_menu/getAllPages',
        type: 'POST',
        datatype:'json',
        success:function(data){
            ...
            $.each(data,function(i){
                console.log(data[i]);
                htmlString +='<option value='+data[i]["meta_title"]+'>'+data[i]["page_title"]+'</option>';
            });
            htmlString+='</select>';
            $("#conid").empty();
   ...
   $.ajax({
    url: '<?php echo SITEURL; ?>footer_menu/getAllModules',
    type: 'POST',
    ...
    success: function(data) {
        ...
        $.each(data, function(i, item) {
            htmlString += "<option value='" + item.module_id + "'>" + item.module_name + "</option>";
        });
