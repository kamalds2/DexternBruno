<div id="layout-wrapper">
    <div class="main-content">  
        ...
        <div class="container-fluid"> 
            <div class="row mt-n5">                 
                <div class="card">            
                    <form id="addPagesForm" autocomplete="off"  class="needs-validation p-2" novalidate method="post" action="<?php echo SITEURL?>services/createPage" enctype="multipart/form-data" >
                         
                        <div class="d-flex flex-column gap-3">
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <label for="edit_page_title" class="form-label">Title <span class="text-danger">*</span> </label>
                                    <input type="text" class="form-control" name="service_title" id="edit_page_title"  />                                
                                </div>
                                <div class="col-lg-12 mb-3">                                 
                                <label for="label" class="form-label">Description: </label>
                                 <textarea  class="ckeditor-classic" name="service_description"  rows="10" cols="100"></textarea> 
                            </div> 
