                ...
                <div class="card-body pb-0 px-4">
                    <div class="container-fluid">
                        <div class="row justify-content-between align-items-center g-3 mb-5 pb-1 pt-3">
                            ...
                            <div class="col-lg-2">
                                <a type="button" class="btn btn-primary w-100 addContact-modal" href="<?php echo SITEURL?>services/addPage"  ><i class="bi bi-plus align-middle"></i> Add HomePageServices</a>
                            </div>
                    </div>
                </div>
            </div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-left gap-2">    
                                                        <div class="editPageDetails">
                                                            <a  href="<?php echo SITEURL;?>services/editHomePage/<?php echo $value->service_id ?>" class="text-muted px-1 d-block"><i class="bi bi-pencil-fill"></i></a>
                                                        </div>                        
                                                        <div>
            ...
            title: "<strong>Confirmation</strong> Box",
                ...
                callback: function (result) {
                  if(result) {            
                    jQuery.ajax({
                        type: "POST",             
                        url:"<?php echo SITEURL; ?>services/deleteHomePage",
                        data: 'page_id='+ delId,
