...
define('VERSION', '1.0');
define('MAINURL', $_SERVER['DOCUMENT_ROOT']."/DexternBruno/admin/");
define("SITEURL", "http://" . $_SERVER['HTTP_HOST'] . '/DexternBruno/admin/');
define("FRONTSITEURL", "http://" . $_SERVER['HTTP_HOST'] . '/DexternBruno/');
define("URL", "http://" . $_SERVER['HTTP_HOST'] . str_replace("index.php/", "", $_SERVER['REQUEST_URI']));
define('BASE', $_SERVER['DOCUMENT_ROOT']."/DexternBruno/admin/");
define("RESTURL","http://" . $_SERVER['HTTP_HOST'] . '/DexternBruno/'.'restful/');
define('PATH', "http://" . $_SERVER['HTTP_HOST'] ."/DexternBruno/admin/");
...
define('WEBURL', $_SERVER['DOCUMENT_ROOT']."/DexternBruno/"); 
