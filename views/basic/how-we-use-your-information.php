...
<div class="fifty-fifty-blocks">
    ...
    <div class="left-block fifty-fifty-block">
                    ...
                    <h1 class="size-medium">How We Use Your Information</h1>
    ...
    <div class="block-circles background-colour-white">
        ...
        <div class="right-side">
            ...
            <div class="circle-inner">
                ...
                <div class="background-image" style="background-image: url(assets/img/how_we_use_your_information_img.jpg); background-position-x: 0%;"></div>
