...
<div class="fifty-fifty-blocks">
    ...
    <div class="left-block fifty-fifty-block">
                    ...
                    <h1 class="size-medium">Privacy and Cookies Notice</h1>
    ...
    <div class="block-circles background-colour-white">
        ...
        <div class="right-side">
            ...
            <div class="circle-inner">
                ...
                <div class="background-image" style="background-image: url(<?php echo THEMEURL;?>assets/img/privacy_img.jpg); background-position-x: 0%;"></div>
    ...
    <div class="right-block fifty-fifty-block background-colour-white about-block">
